...
export default function FeaturesSection() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Get recommended courses, books, and workshops tailored to your needs.",
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Get personalized advice and feedback from our AI career coach.",
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "See how well you match job requirements with our AI scoring system.",
      icon: (
        <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Our AI-powered platform offers everything you need to accelerate your career growth.
          </p>
        </motion.div>
